...
type StorageClient interface {
	...
	ProposeStorageDeal(ctx context.Context, info *StorageProviderInfo, payloadCid cid.Cid, proposalExpiration Epoch, duration Epoch, price TokenAmount, collateral TokenAmount) (*ProposeStorageDealResult, error)
